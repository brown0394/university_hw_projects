...
{
  "\"end of file\"", "error", "\"invalid token\"", "DOUBLE", "NUM", "ADD",
  "SUB", "MUL", "DIV", "MOD", "'('", "')'", "$accept", "E", "T", "F", YY_NULLPTR
};
...
{
      -1,    -8,    -8,    -1,    -1,    -1,    10,    13,    -8,    -8,
      -8,    12,    -8,    -1,    -1,    -1,    -1,    -1,    -8,    13,
      13,    -8,    -8,    -8
};
...
{
       0,    10,     9,     0,     0,     0,     0,     4,     8,    12,
      11,     0,     1,     0,     0,     0,     0,     0,    13,     2,
       3,     5,     6,     7
};
...
{
       9,    10,     1,     2,     3,     4,    19,    20,    11,     5,
      12,     0,    21,    22,    23,    13,    14,    13,    14,     0,
      15,    16,    17,    18
};

static const yytype_int8 yycheck[] =
{
       3,     4,     3,     4,     5,     6,    13,    14,     5,    10,
       0,    -1,    15,    16,    17,     5,     6,     5,     6,    -1,
       7,     8,     9,    11
};
...
{
       0,     3,     4,     5,     6,    10,    13,    14,    15,    15,
      15,    13,     0,     5,     6,     7,     8,     9,    11,    14,
      14,    15,    15,    15
};
...
yyreduce:
  ...
  case 2: /* E: E ADD T  */
#line 66 "ast.y"
                  { (yyval.pval) = binary((yyvsp[-1].pval), (yyvsp[-2].pval), (yyvsp[0].pval)); add((yyval.pval)); head = (yyval.pval); }
#line 1204 "y.tab.c"
    break;

  case 3: /* E: E SUB T  */
#line 67 "ast.y"
                  { (yyval.pval) = binary((yyvsp[-1].pval), (yyvsp[-2].pval), (yyvsp[0].pval)); sub((yyval.pval)); head = (yyval.pval); }
#line 1210 "y.tab.c"
    break;

  case 4: /* E: T  */
#line 68 "ast.y"
                  { (yyval.pval) = (yyvsp[0].pval); head = (yyval.pval); }
#line 1216 "y.tab.c"
    break;

  case 5: /* T: T MUL F  */
#line 70 "ast.y"
                  { (yyval.pval) = binary((yyvsp[-1].pval), (yyvsp[-2].pval), (yyvsp[0].pval)); mul((yyval.pval)); }
#line 1222 "y.tab.c"
    break;

  case 6: /* T: T DIV F  */
#line 71 "ast.y"
                  { (yyval.pval) = binary((yyvsp[-1].pval), (yyvsp[-2].pval), (yyvsp[0].pval)); divide((yyval.pval)); }
#line 1228 "y.tab.c"
    break;

  case 7: /* T: T MOD F  */
#line 72 "ast.y"
                  { (yyval.pval) = binary((yyvsp[-1].pval), (yyvsp[-2].pval), (yyvsp[0].pval)); mod((yyval.pval)); }
#line 1234 "y.tab.c"
    break;
...
#line 1240 "y.tab.c"
  ...
  case 9: /* F: NUM  */
#line 75 "ast.y"
                  { (yyval.pval) = cons(mkint((yyvsp[0].ival)), NULL); (yyval.pval)->kind = TERMINAL; }
#line 1246 "y.tab.c"
    break;

  case 10: /* F: DOUBLE  */
#line 76 "ast.y"
                  { (yyval.pval) = cons(mkdbl((yyvsp[0].dval)), NULL); (yyval.pval)->kind = TERMINAL; }
#line 1252 "y.tab.c"
    break;

  case 11: /* F: SUB F  */
#line 77 "ast.y"
                  { (yyval.pval) = unary((yyvsp[-1].pval), (yyvsp[0].pval)); negate((yyval.pval));}
#line 1258 "y.tab.c"
    break;

  case 12: /* F: ADD F  */
#line 78 "ast.y"
                  { (yyval.pval) = unary((yyvsp[-1].pval), (yyvsp[0].pval)); }
#line 1264 "y.tab.c"
    break;
