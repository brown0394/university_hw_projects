...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   //RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA, ENABLE); // UASRT CLOCK
    ...
    RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA | RCC_APB2Periph_GPIOB |RCC_APB2Periph_GPIOC, ENABLE); // Joystick clock
...
void USART1_2_Init(void) // USART_BaudRate 9600 ���� �� ��Ÿ ������ ��� Putty ������ �����ϰ�.
{
