...
//@TODO - Set the clock SYSCLK = 32 MHz 단, 계산식 제한 : 25 / 5 * 8 / 5 * 4 ////////////////////////////////////////////////////////////////////
        ...
        RCC->CFGR |= (uint32_t)(RCC_CFGR_SW_PLL | RCC_CFGR_PLLMULL4 | RCC_CFGR_PLLSRC_PREDIV1);
        //RCC->CFGR2 &= (uint32_t)~(RCC_CFGR2_PREDIV2 | RCC_CFGR2_PLL2MUL | RCC_CFGR2_PREDIV1 | RCC_CFGR2_PREDIV1SRC);
        RCC->CFGR2 |= (uint32_t)(RCC_CFGR2_PREDIV1SRC | RCC_CFGR2_PLL2MUL8 | RCC_CFGR2_PREDIV2_DIV5 | RCC_CFGR2_PREDIV1_DIV5);
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
